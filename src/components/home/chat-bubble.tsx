...
const ChatBubble = ({ me, message,previousMessage }: ChatBubbleProps) => {
    ...
    return (
      ...
      <div className="flex gap-1 w-2/3">
		<ChatBubbleAvatar
			...
			message={message}
		/>
        <div className={`flex flex-col z-20 max-w-fit px-2 pt-1 rounded-md shadow-sm relative ${bgClass}`}>
  ...
  return (
    ...
    <div className="flex gap-1 w-2/3 ml-auto">
      <div className={`flex z-20 max-w-fit px-2 pt-1 rounded-md ml-auto shadow-sm relative ${bgClass}`}>
